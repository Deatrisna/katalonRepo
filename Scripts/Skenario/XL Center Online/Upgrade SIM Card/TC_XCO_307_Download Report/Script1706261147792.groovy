...
WebUI.click(findTestObject('XL Center Online/Upgrade SIM Card/btnDownload'))

WebUI.delay(1)

WebUI.click(findTestObject('XL Center Online/Upgrade SIM Card/btnConfirmDownload'))
