...
WebUI.click(findTestObject('XL Center Online/Upgrade SIM Card/chooseItem',
	[('item'): 'Upgrade SIM Card']))

WebUI.click(findTestObject('XL Center Online/Upgrade SIM Card/dropdownStatus'))
...
WebUI.focus(findTestObject('XL Center Online/Upgrade SIM Card/btnDownload_EForm'))

WebUI.click(findTestObject('XL Center Online/Upgrade SIM Card/btnDownload_EForm'))
