...
WebUI.focus(findTestObject('XL Center Online/Upgrade SIM Card/02 Approve Data/btnApprove'))

WebUI.click(findTestObject('XL Center Online/Upgrade SIM Card/02 Approve Data/btnApprove'))

WebUI.click(findTestObject('XL Center Online/Upgrade SIM Card/02 Approve Data/btnConfirmApprove'))

WebUI.verifyElementVisible(findTestObject('XL Center Online/Upgrade SIM Card/02 Approve Data/verifyApprove'))
