...
WebUI.setText(findTestObject('XL Center Online/Reactivation/inpTicketID'), '2125')

WebUI.takeScreenshot()

WebUI.click(findTestObject('XL Center Online/Reactivation/btnSearch'))

WebUI.verifyElementVisible(findTestObject('XL Center Online/Reactivation/alertServiceType'))
