...
WebUI.click(findTestObject('XL Center Online/View Profile/02 DUKCAPIL Status/btnDUKCAPILStatus'))

WebUI.click(findTestObject('XL Center Online/View Profile/02 DUKCAPIL Status/btnUnregister'))

WebUI.click(findTestObject('XL Center Online/View Profile/02 DUKCAPIL Status/btnConfirmUnregister'))

WebUI.verifyElementVisible(findTestObject('XL Center Online/View Profile/02 DUKCAPIL Status/verifyUnregister',
