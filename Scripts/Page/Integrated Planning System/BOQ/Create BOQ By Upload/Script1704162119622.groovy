...
WebUI.click(findTestObject('Integrated Planning System/BOQ/Upload/btnNewByUpload'))

WebUI.takeScreenshot()

WebUI.click(findTestObject('Integrated Planning System/BOQ/Upload/btnDownloadTemplate'))

WebUI.uploadFile(findTestObject('Integrated Planning System/BOQ/Upload/uploadFile'), fileBOQ)
