...
WebUI.setText(findTestObject('Lease Management System/ECRF/Create/inputNoECRF'), noECRF)
...
WebUI.verifyElementVisible(findTestObject('Lease Management System/ECRF/Create/linkDetailECRFNumber',[('noECRF'): noECRF]))

WebUI.takeScreenshot()

WebUI.click(findTestObject('Lease Management System/ECRF/Create/linkDetailECRFNumber', [('noECRF'): noECRF]))
