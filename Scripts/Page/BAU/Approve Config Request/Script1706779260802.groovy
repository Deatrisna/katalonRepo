...
WebUI.click(findTestObject('BAU/02 Approve Config Request/My Ticket/btnApprove'))

WebUI.setText(findTestObject('BAU/02 Approve Config Request/My Ticket/inpAdditionalNotes'), AdditionalNotes)

WebUI.takeScreenshot()

WebUI.click(findTestObject('BAU/02 Approve Config Request/My Ticket/btnApproveCont'))

WebUI.verifyElementPresent(findTestObject('BAU/02 Approve Config Request/My Ticket/verifyApproveSuccess'), 3)
