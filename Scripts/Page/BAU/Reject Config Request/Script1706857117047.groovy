...
WebUI.click(findTestObject('BAU/02 Approve Config Request/My Ticket/btnReview'))
...
WebUI.click(findTestObject('BAU/02 Approve Config Request/My Ticket/btnNext02'))

WebUI.takeScreenshot()

WebUI.click(findTestObject('BAU/03 Reject Config Request/btnWithdraw'))

WebUI.setText(findTestObject('BAU/03 Reject Config Request/inpWithdrawReason'), WithdrawReason)

WebUI.click(findTestObject('BAU/03 Reject Config Request/btnSendbackTo'))

WebUI.click(findTestObject('BAU/03 Reject Config Request/btnSendbackTo_value', [('SendbackTo') : SendbackTo]))

WebUI.takeScreenshot()

WebUI.click(findTestObject('BAU/03 Reject Config Request/btnWithdrawConfirm'))//

WebUI.verifyElementPresent(findTestObject('BAU/03 Reject Config Request/verifyWithdrawSuccess'), 3)
