...
WebUI.navigateToUrl('https://stg-newssp.xl.co.id/')

WebUI.maximizeWindow()

WebUI.click(findTestObject('Login/SSP and Heimdal/SSP/btnLoginAzure'))
...
WebUI.click(findTestObject('Login/SSP and Heimdal/SSP/btnYes'))
