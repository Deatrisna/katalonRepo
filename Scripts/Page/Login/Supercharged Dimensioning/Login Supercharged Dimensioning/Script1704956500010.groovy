...
WebUI.navigateToUrl('https://staging.pms.xl.co.id/auth/login')

WebUI.maximizeWindow()

WebUI.click(findTestObject('Login/Supercharged Dimensioning/Supercharged Dimensioning/btnLoginWIthXLAccount'))
